...
import signupImg from '../assetes/signUpImage.png'
...
function Signup() {
  ...
  const signupHandler = () => {
    setLoading(true);
    const { first_name, middle_name, last_name, email, phone_number, password, re_password, role,userBloodGroup } = userData;
    const apiUrl = 'user/signup/';
    api.post(
      apiUrl,
      {
        first_name, middle_name, last_name, email, phone_number, password, re_password, role,userBloodGroup,
        getHeaders,
      }
    ).then((response) => {
            ...
            <div className="form-floating mb-3">
              <div className="col-sm-12 px-0 ">
                ...
                <select
                  ...
                  aria-label="Select the Blood Group"
